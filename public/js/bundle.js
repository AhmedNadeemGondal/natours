(() => {
  ...
  var hideAlert = () => {
    ...
    if (el) (_a = el.parentElement) == null ? void 0 : _a.removeChild(el);
  };
  ...
  // public/js/login.js
  var login = (email, password) => __async(void 0, null, function* () {
    try {
  ...
  var displayMap = (locations) => {
    function calculateCentroid(locations2) {
      ...
      return [sumLon / locations2.length, sumLat / locations2.length];
    }
    ...
    const vectorLayer = new ol.layer.Vector({
      ...
      style: new ol.style.Style({
        image: new ol.style.Icon({
          anchor: [0.5, 1],
          // Adjust anchor so the bottom of the pin touches the location
          src: "/img/pin.png",
  ...
  `;
      ...
      const overlay2 = new ol.Overlay({
        ...
        // Centers horizontally, places popup above
        offset: [0, 5]
        // Moves popup 10px downward
      });
